...
module "core_info" {
  source              = "git@github.com:Chewy-Inc/core-info-aws-tf-module.git//terraform?ref=0.5.72"
...
locals {
  ...
  resource_short_name = "chewy-${trimsuffix(module.core_info.resource_name_prefix, "-")}"
  resource_long_name  = "chewy-${trimsuffix(module.core_info.resource_name_full_region_prefix, "-")}"

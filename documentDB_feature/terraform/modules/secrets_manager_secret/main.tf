...
locals {
  resource_name_prefix = "/chewy/${var.core_info.input_vars.environment}/${var.core_info.short_region}/${var.core_info.input_vars.app_name}/docdb/${var.secret_name}"
}
...
resource "aws_secretsmanager_secret" "secret" {
  ...
  tags                    = var.bypass_replication ? merge(var.core_info.required_tags, { "chewy:bypass-replication-tag" = "true" }) : var.core_info.required_tags
}
